...
<body>
  ...
  <div class="pagetitle">
    ...
    <div class="container-fluid bg-white rounded" style="box-shadow: 0px 0px 20px rgba(1, 41, 112, 0.1)">
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                        ...
                        <div class="panel panel-white">
                            <div class="panel-body">
                                ...
                                <form role="form" name="dcotorspcl" method="post" >
                                    ...
                                    <button type="submit" name="submit" class="btn btn-outline-success m-2">Update</button>
                                </form>
                            </div>
                        </div>
                    </div>
